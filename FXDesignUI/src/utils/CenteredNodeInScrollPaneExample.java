...
//          node.setScaleX(3); node.setScaleY(3);
          redrawImage((Canvas) node,3);
        } else {
//          node.setScaleX(1); node.setScaleY(1);
          redrawImage((Canvas) node,1);
        }
...
//    nodeContainer.setManaged(false);
  ...
  private Canvas createSquare() { // create a square to be acted on by the controls.
...
//	  BufferedImage bufferedImage = new BufferedImage((int) (canvas.getWidth()*scale), 
//				 (int) canvas.getHeight()*scale, BufferedImage.TYPE_INT_RGB);
//	  Graphics2D g2d = bufferedImage.createGraphics();
//	  System.out.println("bufferedImage: "+bufferedImage.getWidth()+","+bufferedImage.getHeight());
//	  g2d.setColor(java.awt.Color.red);
//	  g2d.drawRect(100, 100, 100*scale, 100*scale);
//	  g2d.drawLine(0, 0, (int)bufferedImage.getWidth(), (int)bufferedImage.getHeight());
//	  g2d.drawLine(0, (int)bufferedImage.getWidth(), (int)bufferedImage.getHeight(),0);
//	  g2d.drawString("TEXT", 90, 90);
//	  g2d.clipRect(0, 0, (int)canvas.getWidth(), (int)canvas.getHeight());
//	  
...
//	  gc.drawImage(img, 0, 0);
	  ...
	  gc.setStroke(Color.RED);
	  gc.setLineWidth(1);
	  gc.strokeRect(100, 100, 100*scale, 100*scale);
	  gc.setLineWidth(1);
	  gc.setStroke(Color.GREEN);
	  gc.strokeLine(0, 0, canvas.getWidth()*scale, canvas.getHeight()*scale);
	  gc.strokeLine(0, canvas.getHeight()*scale, canvas.getWidth()*scale, 0);
	  gc.setStroke(Color.BLUE);
	  gc.strokeText(""+300/scale, 10, canvas.getHeight()-10);
	  gc.strokeText(""+scale, 10, 10);
